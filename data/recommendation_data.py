...
BOOK_DATA = {
    ...
    "설렘": [
        {"title": "해리 포터 시리즈", "author": "J.K. 롤링", "description": "마법 세계의 모험과 우정을 담은 판타지 소설"},
        {"title": "노르웨이의 숲", "author": "무라카미 하루키", "description": "풋풋한 사랑과 설렘을 그린 청춘 소설"},
        {"title": "로미오와 줄리엣", "author": "윌리엄 셰익스피어", "description": "영원한 사랑 이야기"},
        {"title": "82년생 김지영", "author": "조남주", "description": "공감과 변화에 대한 설렘"},
    ],
    "슬픔": [
...
MUSIC_DATA = {
    ...
    "설렘": [
        {"title": "Blueming", "artist": "아이유", "description": "사랑스럽고 달콤한 감성의 곡"},
        {"title": "Eight", "artist": "아이유", "description": "설레는 감성의 노래"},
        {"title": "Can't Help Falling in Love", "artist": "Elvis Presley", "description": "로맨틱한 사랑 노래"},
        {"title": "Beautiful", "artist": "Crush", "description": "달콤한 R&B"},
    ],
    "슬픔": [
...
FOOD_DATA = {
    ...
    "설렘": [
        {"name": "초밥", "description": "신선한 재료의 행복한 한 입", "category": "일식"},
        {"name": "스테이크", "description": "특별한 날을 위한 고급 요리", "category": "양식"},
        {"name": "파스타", "description": "로맨틱한 분위기의 이탈리안", "category": "양식"},
        {"name": "마카롱", "description": "알록달록 예쁜 디저트", "category": "디저트"},
    ],
    "슬픔": [
    ...
    "분노": [
        ...
        {"name": "양꼬치", "description": "향신료 가득한 중식", "category": "중식"},
    ],
    "보통": [
